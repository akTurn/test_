...
SECRET_KEY = 'django-insecure-nw0&%1v@@@^k3%vvu9w=gyaqqlu!^t^tx2)%h+qiy)=g0=v=-y'
...
WSGI_APPLICATION = 'aksite.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'aksite/static']
